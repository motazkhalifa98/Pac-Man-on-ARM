...
SPACEFORSTACK6:	.string	"                                                                                                                                                               ",0
	...
	.global TimerSlowhandler
	.global TimerFasthandler
	.global move_pacman
	...
	; in lab_7_library.s
  	...
  	.global timer_init
	.global TimerSlow_interrupt_clear
	.global TimerFast_interrupt_clear
  	.global RGB_LED_init
...
donecleaning:
	...
	BL	reset_game_speed					;reset speed to normal
...
TimerSlowhandler:
		...
		BL TimerSlow_interrupt_clear

		LDR			r5,		ptr_to_game_status
		LDRB		r11,	[r5]
		CMP			r11,	#0
		BEQ			slowhandled		;don't do anything, game isn't up yet
		CMP			r11, 	#1
		BEQ			slownormalmode
		CMP			r11,	#2
		BEQ			slownotnormalmode
		CMP			r11,	#3
...
TimerFasthandler:
    ...
    BL 	TimerFast_interrupt_clear

	LDR			r5,		ptr_to_game_status
	LDRB		r11,	[r5]
	CMP			r11,	#0
	BEQ			fasthandled		;don't do anything, game isn't up yet
	CMP			r11, 	#1
	BEQ			fastnormalmode
	CMP			r11,	#2
	BEQ			fastnotnormalmode
	CMP			r11,	#3
...
donecopy:
		...
		BL print
		BL speed_up_new_level 	;increase speed
