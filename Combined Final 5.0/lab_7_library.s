...
delay: SUB r10, r10, #1
	  ...
	  ; put Timer1 into periodic mode
		...
		; set up interrupt interval for timer0 timerSlow GPTMTAILR
	  ...
	  ; set up interrupt interval for timer1 timerFast GPTMTAILR
		...
		; write 1 (enable) to TATOIM (bit 0) for TimerSlow
		MOV r8, #0x0018
		MOVT r8, #0x4003
		LDR r9, [r8]
		ORR r9, r9, #0x1
		...
		; write 1 to TAEN (bit 0) for TimerSlow
		MOV r8, #0x000C
		MOVT r8, #0x4003
		LDR r9, [r8]
		ORR r9, r9, #0x1
